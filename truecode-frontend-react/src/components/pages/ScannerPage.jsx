...
const ScannerPage = () => {
    ...
    useEffect(() => {
        ...
        try {
            // ✅ Ensure qrData is properly parsed
            ...
            if (contractAddress) {
                if (contractAddress === CONTRACT_ADDRESS) {
                    if (auth.role === "supplier" || auth.role === "retailer") {
                        navRole();  // ✅ Navigate for supplier/retailer
                    } else {
                        navUser();  // ✅ Navigate for normal user
                    }
                } else {
                    navFakeProduct();  // ✅ Navigate for fake products
                }
            }
        } catch (error) {
