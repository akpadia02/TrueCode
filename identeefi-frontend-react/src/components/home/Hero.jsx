...
import Navbar from "./Navbar";
import bgImg from "../../img/bg.png";
import heroImg from "../../img/landingpic.jpg";
import CustomButton from "./CustomButton";
import { Link } from "react-router-dom";
...
const Hero = () => {
  ...
  return (
    <Box sx={{ backgroundColor: "#000E0F", minHeight: "95vh" }}>
      <Container>
        <Navbar />
        <CustomBox>
          <Box sx={{ flex: "2" }}>
            ...
            >
            <h1>Welcome to TrueCode</h1>
            </Typography>
            <Title variant="h1" sx={{ color: "#ffffff", my: 0 }}>
              Securely Authenticate Your Products with TrueCode
            </Title>
            <Typography
              variant="body2"
              sx={{ fontSize: "18px", color: "#14BFB7", my: 4 }}
            >
              Our blockchain-based product identification system provides a secure and reliable way to authenticate your products and protect against fraud
            </Typography>
            <Link to="/scanner">
